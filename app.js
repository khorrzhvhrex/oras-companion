...
const EXTRA_AREAS = [
  ...
  {id:"petalburg-woods",name:"Petalburg Woods",unlock:1,encounters:{walk:["Zigzagoon",
        "Wurmple",
        "Silcoon",
        "Cascoon",
        "Shroomish",
  ...
  {
    id:"sea-mauville-deep",
    name:"Sea Mauville — Deep Interior",
    unlock:28,
    requires:"dive",
    encounters:{
      static:[
  ...
  {
    id:"island-cave-regigigas",
    name:"Island Cave — Regigigas",
    unlock:36,
    encounters:{
      static:["Regigigas"]
    }
  ...
  {
    id:"sky-pillar-summit",
    name:"Sky Pillar — Summit",
    unlock:33,
    encounters:{
      static:[
        "Rayquaza",
  ...
  // =========================================================
  // DAILY MIRAGE ISLAND FAMILY
  // =========================================================

  {
    id:"mirage-island",
    name:"Mirage Island — Daily Pool",
    unlock:22,
    requires:"soar",
    encounters:{
      mirage:[
  ...
  // =========================================================
  // DAILY MIRAGE CAVE FAMILY
  // =========================================================

  {
    id:"mirage-cave",
    name:"Mirage Cave — Daily Pool",
    unlock:22,
    requires:"soar",
    encounters:{
      mirage:[
  ...
  // =========================================================
  // DAILY MIRAGE FOREST FAMILY
  // =========================================================

  {
    id:"mirage-forest",
    name:"Mirage Forest — Daily Pool",
    unlock:22,
    requires:"soar",
    encounters:{
      mirage:[
  ...
  // =========================================================
  // DAILY MIRAGE MOUNTAIN FAMILY
  // =========================================================

  {
    id:"mirage-mountain",
    name:"Mirage Mountain — Daily Pool",
    unlock:22,
    requires:"soar",
    encounters:{
      mirage:[
  ...
  {
    id:"soaring-rifts",
    name:"Soaring — Dimensional Rifts / Storm Clouds",
    unlock:36,
    requires:"soar",
    encounters:{
      static:[
